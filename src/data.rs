pub fn get_conf_text()->String{
    ...
    0 -Режим генерации пароля (0 последовательный перебор),(1 рандом),(2 комбинированый)\n\
    1 -Количество знаков последовательного перебора слева(для комбинированого режима) \n\
    ---------------------------\n\
    Описание:\n\

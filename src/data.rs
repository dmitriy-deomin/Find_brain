pub fn get_conf_text()->String{
    ...
    0 -Режим генерпции пароля (0 последовательный перебор),(1 рандом),(2 комбинированый)\n\
    0 -Количество знаков последовательного перебора слева(для комбинированого режима) \n\
    ---------------------------\n\
    Описание:\n\
